...
import { MpActionToolbarComponent } from '@app/shared/libs/mp-action-toolbar/mp-action-toolbar.component';
...
@Component({
  ...
  imports: [CommonModule, MatTableModule, TranslateModule, MatPaginatorModule, MatCheckboxModule,
    MpButtonComponent, MatIconModule, MatButtonModule, FormsModule, ReactiveFormsModule,
    NgSelectModule, MpLoaderComponent, MpActionToolbarComponent, MpInputComponent],
