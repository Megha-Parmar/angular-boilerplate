...
import { MpInputComponent } from '@app/shared/libs/mp-input/mp-input.component';
import { MpTelInputComponent } from '@app/shared/libs/mp-tel-input/mp-tel-input.component';
import {
  COUNTRY_LIST,
  CURRENCY_LIST,
  LANGUAGE_LIST,
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatSlideToggleModule, NgSelectModule, FormsModule, MpButtonComponent, ReactiveFormsModule,
    TranslateModule, AllowNumberOnlyDirective, MpTelInputComponent, MpInputComponent],
...
export class PartnerAddComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.mpEventsService.emitBreadcrumbsDetail(this.breadcrumbs);
    this.initializeForm();
  }
