...
@Component({
  selector: 'app-mp-tel-input',
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
  templateUrl: './mp-tel-input.component.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => MpTelInputComponent),
      multi: true
    },
    {
...
export class MpTelInputComponent implements OnInit, AfterViewInit {
  ...
  public ngAfterViewInit(): void {
    if (this.onlyLocalized) {
      MpTelInputComponent.modifyCountryData();
    }
