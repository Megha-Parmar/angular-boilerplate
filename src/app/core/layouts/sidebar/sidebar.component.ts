...
import { MpSvgIconComponent } from '@app/shared/libs/mp-svg-icon/mp-svg-icon.component';
...
@Component({
  ...
  standalone: true,
  imports: [MatIconModule, NgSelectModule, TranslateModule, RouterModule, FormsModule, MpSvgIconComponent],
...
export class SidebarComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.mpEventsService.toggleSidebar
